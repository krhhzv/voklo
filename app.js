...
function cloneInvoice() {
  ...
  // Add header to export without watermark
  const headerHTML = `
  <div style="display: flex; align-items: center; justify-content: flex-end; margin-bottom: 24px; padding-bottom: 16px; border-bottom: 1px solid #e5e7eb; font-family: 'Inter', sans-serif;">
